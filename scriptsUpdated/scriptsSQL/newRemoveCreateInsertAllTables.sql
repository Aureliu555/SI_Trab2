...
INSERT INTO public.cliente(
	...
	VALUES 
	(659486259, 'Jo�o Bai�o', 965843129, 'Rua D. Jo�o I N4'),
	(689425389, 'Guilhereme Santos', 984629857, 'Rua das Laranjeiras N17'),
	(123456789, 'Edgar Batista', 912346508, 'Rua Macieira Da Vov� N20'),
	...
	(765865645, 'M�nica Sebasti�o', 965843129, 'Rua D. Jo�o I N4'),
	(435344578, 'Gon�alo Pasmatti', 984629857, 'Rua das Laranjeiras N16'),
	(175495354, 'Sofia Brand�o', 975867547, 'Rua Moranguinho Verde N7'),
	(764953465, 'Sandra Gomes', 922224543, 'Rua D. Jo�o I N4'),
	(854645646, 'Bruna Carvalho', 901343454, 'Rua das Laranjeiras N16'),
	(247554854, 'Beatriz Clemente', 914768921, 'Rua Anona Fresca N1'),
	(383454584, 'Amanda de Sousa', 925843129, 'Rua D. Jo�o I N4'),
...
INSERT INTO public.veiculo(
	...
	VALUES 
	('20-VT-65', 659486259, 'F�bio Fernandes', null, null),
	('40-AB-15', 689425389, 'R�ben Castro', 975463454, null),
	('89-GG-25', 689425389, 'Pedro Guimar�es', 985628349, null),
	...
	('CD-TH-10', 388065105, 'N�dia Susana', 915626349, null)
	;
...
INSERT INTO public.registoNProcessado(
	...
	VALUES 
	(3.0, 9.5, null, 1),				-- inv�lido, devido a data
	(6.8, 4.2, '2022-01-02', 1),		-- v�lido
	(5.3, 1.0, '2020-02-13', null),	-- inv�lido pelo identificador de gps
	(1.9, 6.0, '2022-04-20', 2),
	(4.0, 3.5, '2021-03-05', 1),
	(3.6, 4.7, null, 4),				-- inv�lido, devido a data
